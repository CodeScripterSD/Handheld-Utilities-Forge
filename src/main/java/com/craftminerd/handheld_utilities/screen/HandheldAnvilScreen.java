...
public class HandheldAnvilScreen extends ItemCombinerScreen<HandheldAnvilMenu> {
    ...
    public HandheldAnvilScreen(HandheldAnvilMenu pMenu, Inventory pPlayerInventory, Component pTitle) {
